-- =========================================================
-- Virtual Museum - FINAL combined schema + complex queries
-- Based on your original code.sql and Complex_queries.txt
-- =========================================================
...
CREATE TABLE User (
    ...
    Password VARCHAR(255) NOT NULL,          -- store hashed or plain (your app controls this)
...
-- =========================================================
-- ARTIFACTS
-- (app uses: Image (relative path), Quantity (stock), Price, Type, Title, M_ID, Artist_ID)
-- =========================================================
CREATE TABLE Artifact (
    ...
    Image VARCHAR(255),              -- store relative file path under /static, e.g. 'uploads/file.jpg'
    Created_At TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
-- =========================================================
-- EXHIBITIONS (Artist creates exhibitions)
-- =========================================================
...
-- =========================================================
-- EXHIBITION_ARTIFACT (optional/kept)
-- =========================================================
...
-- =========================================================
-- ATTENDS (kept; app currently not registering customers in exhibitions)
-- =========================================================
...
-- (app inserts here at checkout and decrements stock)
-- =========================================================
...
-- =========================================================
-- TRIGGERS (stock-safe checkout; artist-only exhibitions)
-- =========================================================
DELIMITER //
...
-- =========================================================
-- VIEWS (transactions + friendly-named complex queries)
-- =========================================================

-- Transactions view the Admin page reads
...
-- Complex Query 1 (from your file): Customers Above Average Spend
...
-- Complex Query 2: Artifacts Above Artist’s Average Price
...
-- Complex Query 3: Artists With Multiple Distinct Artifacts Sold
...
-- Complex Query 4: Museum Sales & Rank
...
-- Complex Query 5: Most Expensive Artifact per Type
...
-- =========================================================
-- SAMPLE DATA (includes image paths used by the app)
-- =========================================================
...
-- Artifacts (note Image paths under /static: 'uploads/...')
...
-- Optional mapping, visits, attends
...
-- Seed purchases to make admin transactions/queries useful
...
-- =========================================================
-- OPTIONAL: DB USERS & PRIVILEGES (match your .env)
-- =========================================================
